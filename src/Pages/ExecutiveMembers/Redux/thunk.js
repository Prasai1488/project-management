...
export const getExecutiveMembers = createAsyncThunk(
  "executiveMembers/getExecutiveMembers",
...
export const getAllExecutiveMembers = createAsyncThunk(
  "executiveMembers/getAllExecutiveMembers",
...
// get particular page
export const getPageExecutiveMembers = createAsyncThunk(
  "executiveMembers/getPageExecutiveMembers",
...
export const createExecutiveMembers = createAsyncThunk(
  "executiveMembers/createExecutiveMembers",
  async (data, { rejectWithValue }) => {
...
export const updateExecutiveMembers = createAsyncThunk(
  "executiveMembers/updateExecutiveMembers",
  async (data, { rejectWithValue }) => {
