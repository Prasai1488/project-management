...
import { getAllCategories, handleCategorySearch } from "../Redux/thunk"; // Adjust imports to match Category slice
import CreateCategory from "./CreateCategory"; // Create category form component
import "./category.css";
import CategoryListing from "./CategoryListing"; // Create category listing component
...
const Category = () => {
  ...
  useEffect(() => {
    if (search === "") {
      ...
      dispatch(handleCategorySearch({ search, postsPerPage }));
    }
