...
// get user group
export const getUserGroup = createAsyncThunk("userGroup/getUserGroup", async (postsPerPage, { rejectWithValue }) => {
  try {
...
// get all user groups
export const getAllUserGroup = createAsyncThunk("userGroup/getAllUserGroup", async (_, { rejectWithValue }) => {
  try {
...
// get previous
export const getPrevious = createAsyncThunk("userGroup/getPrevious", async (previous, { rejectWithValue }) => {
  try {
...
// get next
export const getNext = createAsyncThunk("userGroup/getNext", async (next, { rejectWithValue }) => {
  try {
...
// get particular page
export const getPageUserGroup = createAsyncThunk("userGroup/getPageUserGroup", async (data, { rejectWithValue }) => {
...
// create user group
export const createUserGroup = createAsyncThunk("userGroup/createUserGroup", async (data, { rejectWithValue }) => {
...
// get all permission
export const getAllPermission = createAsyncThunk("userGroup/getAllPermission", async (_, { rejectWithValue }) => {
  try {
...
// handle search
export const handleSearch = createAsyncThunk("userGroup/handleSearch", async (data, { rejectWithValue }) => {
